...
# duplicate rows are rows that have been register more than ine time 
...
data = [
    ...
    {"Duration": 45, "Date": None, "Pulse": 90, "Maxpulse": 112, "Calories": None},
...
# return true for every row that us duolicate, otherwise false
...
df.drop_duplicates(inplace = True) # it remove the row in which contain the duplicate value 
